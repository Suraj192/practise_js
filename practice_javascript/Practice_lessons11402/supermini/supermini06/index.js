class NameVariations {
  ...
  getNumberOfChars() {
    return document.querySelector("#your-name").value.length;
    // return the number of characters in: name
  }

  getLower() {
    // return name all in lower case (example: "ABC" becomes "abc")
    return document.querySelector("#your-name").value.toLowerCase();
  }

  getUpper() {
    // return name all in upper case (example: "abc" becomes "ABC")
    return document.querySelector("#your-name").value.toUpperCase();
  }
}
