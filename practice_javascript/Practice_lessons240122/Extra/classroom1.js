...
const peoples = ["Sergei", "Mariia", "Boris", "Abel"];
...
peoples.unshift("Mahalete");
console.log(peoples);

peoples.splice(3, 0, "Suraj");
console.log(peoples);

console.log(peoples.slice(-2));
console.log(peoples.indexOf("Mariia"));
console.log(peoples.indexOf("Foo"));
console.log(peoples.splice(2, 1, "Rakhi", "Yulia"));
console.log(peoples);
